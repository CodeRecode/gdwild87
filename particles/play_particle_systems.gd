@tool
class_name PlayParticlesSystem
extends Node3D
...
func _cleanup_delays() -> void: # Remove delays for particles that no longer exist	
...
func _playDelay(ps: GPUParticles3D, delay: float) -> void:
